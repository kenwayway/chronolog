...
// ../.wrangler/tmp/pages-BVXCF7/functionsRoutes-0.2604575301468782.mjs
var routes = [
  {
    routePath: "/api/image/:id",
    mountPath: "/api/image",
    method: "GET",
    middlewares: [],
...
// C:/Users/POI/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/POI/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
