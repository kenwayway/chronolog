...
//
// Thumbnails are stored as separate R2 objects with a ".thumb" suffix
// (generated client-side at upload time), so they are served by this same
// handler — no server-side transform involved.
