            ...
            <div style={{
                ...
                >
                    ...
                    {(imageUrl || location || showImageInput || showLocationInput) && (
                        <div style={{ padding: '8px 20px', borderTop: '1px solid var(--border-subtle)', backgroundColor: 'var(--bg-secondary)' }}>
                            {/* Image URL Input */}
                            {showImageInput && (
                    ...
                    <div className="flex-between" style={{
                        ...
                        <div className="flex items-center gap-4">
                            {/* Time */}
                            <div className="flex items-center gap-2">
                                <span style={{ fontSize: 10, color: 'var(--text-dim)', userSelect: 'none' }}>TIME</span>
                                <input
                                    type="datetime-local"
                                    value={timestamp}
                            ...
                            {/* Category */}
                            <div className="flex items-center gap-2">
                                <span style={{ fontSize: 10, color: 'var(--text-dim)', userSelect: 'none' }}>CATEGORY</span>
                                <select
                                    value={category || ''}
                                    ...
                                    style={{
                                        width: 120,
                                        color: selectedCategory ? selectedCategory.color : 'var(--text-secondary)'
                                    }}
                                >
                        ...
                        <div className="flex items-center gap-3">
                            <span style={{ fontSize: 10, color: 'var(--text-dim)', userSelect: 'none' }}>Ctrl+Enter to save</span>
                            <button onClick={handleSave} className="edit-modal-btn-save">Save</button>
                        </div>
                    </div>
                </div>
            </div>
