...
import { ListTodo, Settings, ChevronLeft, ChevronRight, Moon, Sun } from 'lucide-react'
        ...
        days.push(
            <button
                ...
                style={{
                    ...
                    backgroundColor: isSelected ? 'var(--accent)' : isToday ? 'var(--accent-subtle)' : 'transparent',
                    color: isFuture ? 'var(--text-dim)' : isSelected ? 'white' : isToday ? 'var(--accent)' : 'var(--text-secondary)',
                    fontWeight: isToday || isSelected ? 600 : 400,
                    transition: 'all 150ms ease'
                }}
                onMouseEnter={(e) => !isFuture && !isSelected && (e.target.style.backgroundColor = 'var(--bg-tertiary)')}
                onMouseLeave={(e) => !isSelected && (e.target.style.backgroundColor = isToday ? 'var(--accent-subtle)' : 'transparent')}
            >
                {day}
            </button>
        )
    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                ...
                <button
                    ...
                    style={{
                        ...
                        borderRadius: 4,
                        backgroundColor: 'transparent',
                        color: new Date(year, month + 1, 1) > today ? 'var(--text-dim)' : 'var(--text-secondary)',
                        cursor: new Date(year, month + 1, 1) > today ? 'default' : 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center'
                    }}
            ...
            <button
                ...
                onMouseEnter={(e) => e.target.style.backgroundColor = 'var(--accent-subtle)'}
    ...
    return (
        <header className="header">
            <div className="flex items-center gap-3">
                ...
                {/* Date Navigation */}
                <div className="flex items-center gap-1 relative" style={{ marginLeft: 8 }}>
                    <button
                    ...
                    <button
                        className="btn btn-ghost"
                        style={{ width: 28, height: 28, padding: 0, opacity: isToday ? 0.3 : 1 }}
                        onClick={goToNextDay}
                        disabled={isToday}
                        title="Next day"
                    >
